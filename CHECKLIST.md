...
| ✅ | ops-fab-01 | 地下城芯片厂（洁净室，一厂三线） | code(interior) | ✅ 8卡（三产线台账蒸馏：MB-1 sky130 / SPAD CRN65LP / QP-20 JJ） | n/a 室内（pos null，§4b；玄关右墙 z=-2.5 门组 ↔ INTERIOR_DOORS 双向） | 07-31 总控交付（真源 mars-bigram + mars_spad_rox + quantum-computing）：5.1k 面；黄光区琥珀隔断+黄光带、层流 HEPA 格栅顶、更衣段（洁净服/风淋）；蒸发台开腔露倾斜样品台+双蒸发源=「双角度」可读；晶圆机器人摆臂（oscillator）+ 旋涂盘/划片刀（spinner×2）+ 光刻曝光光束/蒸发辉光/坏品die 呼吸（animate）；大屏=实时晶圆图+MB-1 版图（4 SRAM 宏占 64% 一屏可读）；门位避让账:z=-5 撞 CO2 洗涤柜、z=-9 撞机器人充电桩,定版 z=-2.5 |
