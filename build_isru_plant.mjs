...
// ---------------------------------------------------------------- POI anchors (MODELS.md §5)
// named empty nodes at each core sub-device; models/res-isru-01/info.json
// carries the matching knowledge cards, engine shows them by distance LOD
for (const [pid, px, py, pz] of [
  ['reactor', 10, 4.5, -4],
  ['intake', -8.8, 2.5, 6],
  ['electrolysis', 2.2, 2.2, 1.0],
  ['tanks', -4, 3.0, -5.5],
  ['radiators', 16.2, 2.2, -2.0],
  ['flare', 14, 4, 8],
]) {
